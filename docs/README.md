...
| **0.18** | [0.18-enhancement-chord.md](./phases/0.18-enhancement-chord.md) | 增强与 Chord 体验（存量修复 / 截图 / 便签 IR / 托盘 / 命令执行 / 输入状态流转重构） | 🚧 0.18.7 规划中 |
...
| 0.18.x | 增强与 Chord 体验（0.18.0～0.18.6 已完成；0.18.7 收敛 Alt/Chord 输入状态流转） | 🚧 0.18.7 规划中 |
