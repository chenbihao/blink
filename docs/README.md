...
| **0.23** | [0.23-editor-voice-ai-workflow.md](./phases/0.23-editor-voice-ai-workflow.md) | 单会话文本工作台、Preview/Draft 双层识别、AI 确认与主链路稳定性收口；0.23.12 统一资源 ref 层、0.23.14 VAD/Preview-Draft 收尾、0.23.15 截图实线选区拖动流畅度均已完成 | 🚧 |
...
| 0.23.x | 单会话编辑底座、连续听写、Preview/Draft 双层识别、显式 AI 整理与主链路稳定性收口；0.23.15 截图实线选区拖动流畅度专项 | 🚧 0.23.0~0.23.15 完成（0.23.15 真机手动验收矩阵待执行） |
