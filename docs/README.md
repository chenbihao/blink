...
| **0.23** | [0.23-editor-voice-ai-workflow.md](./phases/0.23-editor-voice-ai-workflow.md) | 单会话文本工作台、Preview/Draft 双层识别、AI 确认与主链路稳定性收口；0.23.12 统一资源 ref 层已完成，0.23.14 VAD/Preview-Draft 稳定性规划中 | 🚧 |
...
| 0.23.x | 单会话编辑底座、连续听写、Preview/Draft 双层识别、显式 AI 整理与主链路稳定性收口 | 🚧 0.23.0~0.23.13 完成；0.23.14 VAD/Preview-Draft 稳定性规划中 |
