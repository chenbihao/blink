...
| 0.22.x | 本地模型运行时、FunASR 生命周期与模型资产迁移、PP-OCRv6/WinRT、Nano GGUF 与 ONNX 候选实现 | 🚧 0.22.0～0.22.9 完成（GGUF FunASR、契约收口、OCR ONNX、STT 双 runtime/VAD/真流式；注册门证据项按用户决策收口为遗留观察）；剩余 0.22.10 Python/uv 清理 + UI/UX 打磨 |
