...
| **0.23** | [0.23-editor-voice-ai-workflow.md](./phases/0.23-editor-voice-ai-workflow.md) | 单会话文本工作台（Source/MD、连续听写、本次听写整理、Diff 确认） | 📋 |
...
| 0.23.x | 单会话编辑底座、连续听写、通用 voice-overlay、显式 AI 整理与 Diff 确认 | 📋 规划中 |
