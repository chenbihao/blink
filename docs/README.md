...
| **0.22** | [0.22-local-model-runtime-ppocrv6.md](./phases/0.22-local-model-runtime-ppocrv6.md) | 本地模型运行时、PP-OCRv6 与常驻 GGUF FunASR替换 | 🚧 |
...
| 0.22.x | 本地模型运行时、FunASR 生命周期与模型资产迁移、PP-OCRv6 可选后端、WinRT 回退及常驻 GGUF FunASR替换 | 🚧 0.22.0～0.22.6 已完成；0.22.7.1 spike已通过，0.22.7.2～0.22.7.4待实施 |
