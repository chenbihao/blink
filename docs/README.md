...
| **0.23** | [0.23-editor-voice-ai-workflow.md](./phases/0.23-editor-voice-ai-workflow.md) | 编辑器语音与 AI 工作流（连续听写、通用语音浮窗、选区 AI、Diff 确认替换） | 📋 |
...
| 0.23.x | 编辑器连续听写、voice-overlay 双形态语音浮窗、选区 AI 与 Diff 确认替换 | 📋 规划中 |
