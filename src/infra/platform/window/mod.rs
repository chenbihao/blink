...
#[cfg(target_os = "windows")]
pub use windows::{
    PinImage, ack_chat_prefill, apply_cloak, center_of_active_monitor, clamp_context_menu,
    ...
    get_or_create_context_menu_window, get_pin_image, get_pin_window_rect,
    get_primary_monitor_center, hide, hide_chat_window, hide_for_screenshot,
    ...
    preheat_main_window, preheat_secondary_windows, refresh_pin_image, restore_foreground,
    set_app_exiting, set_context_menu_payload, set_main_ai_active, show_chat_window,
    show_content_editor_window, show_image_editor_window, show_pin_window, show_screenshot_overlay,
    show_sticky_manager_window, show_sticky_window, show_voice_overlay, show_welcome_window,
    start_watchdog, take_chat_prefill, take_context_menu_payload, unhide_after_screenshot,
    update_grace_period, update_sticky_taskbar, wait_frame_after_hide,
};
