...
pub use windows::{
    ...
    last_external_foreground_hwnd, on_focused, open_settings, place_at_physical,
    preheat_secondary_windows, restore_foreground, set_app_exiting, set_main_ai_active,
    show_chat_window, show_content_editor_window, show_pin_window, show_screenshot_overlay,
