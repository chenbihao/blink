...
pub use windows::{
    ...
    invoke, is_main_ai_active, is_visible, last_external_foreground_hwnd, mark_spare_ready,
    on_focused, open_settings, place_at_physical, preheat_secondary_windows, refresh_pin_image,
    restore_foreground, set_app_exiting, set_main_ai_active, show_chat_window,
