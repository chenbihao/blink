...
pub use windows::{
    ...
    get_primary_monitor_center, hide, hide_chat_window, hide_for_screenshot, hide_image_editor_window, hide_screenshot_overlay,
    ...
    set_main_ai_active, show_chat_window, show_content_editor_window, show_image_editor_window, show_pin_window,
