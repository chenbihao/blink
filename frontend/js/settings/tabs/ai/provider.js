...
import {AI_KIND_LABEL, aiState, escapeAttr, escapeHtml, fetchAvailableModelsFor, saveAIConfig} from "./state.js";
...
export const AI_PRESET_CATALOG = {
    ...
    "deepseek-anthropic": {
        ...
        display_name_default: "DeepSeek (Anthropic)",
        monogram: "深度",
        tint: "blue",
        category: "cn"
    },
    ...
    "zhipu-anthropic": {
        ...
        display_name_default: "Zhipu (Anthropic)",
        monogram: "智谱",
        tint: "indigo",
        category: "cn"
    },
    ...
    "volcengine-anthropic": {
        ...
        display_name_default: "Volcengine (Anthropic)",
        monogram: "火山",
        tint: "rose",
        category: "cn"
    },
    ...
    "xiaomimimo": {
        ...
        display_name_default: "Xiaomi MiMo",
        monogram: "小米",
        tint: "orange",
        category: "cn"
    },
    "xiaomimimo-anthropic": {
        ...
        display_name_default: "Xiaomi MiMo (Anthropic)",
        monogram: "小米",
        tint: "orange",
        category: "cn"
    },
    ...
    "perplexity": {
        ...
        display_name_default: "Perplexity",
        monogram: "Px",
        tint: "teal",
        category: "gw"
    },
    "huggingface": {
        ...
        display_name_default: "Hugging Face",
        monogram: "HF",
        tint: "amber",
        category: "gw"
    },
    ...
    "lm-studio": {
        ...
        display_name_default: "LM Studio",
        monogram: "LM",
        tint: "slate",
        category: "local"
    },
...
export async function saveNewProviderFromModal() {
    ...
    if (editProviderId) {
        await saveEditedProvider(editProviderId, {
            displayName,
            baseUrl,
            apiKey,
            errEl,
            selectedModels: aiState._providerSelectedModels
        });
    } else {
        await saveNewProvider({
            kind,
            displayName,
            baseUrl,
            apiKey,
