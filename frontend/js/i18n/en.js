...
// ── 0.21.6 Capabilities ──
    ...
    "local_engine.config.requires_restart_hint": "Preference saved; restart the service to apply it.",

    // ── Compute preference display names ──
    "local_engine.compute.unavailable": "Unavailable",
    ...
    "local_engine.compute.requested": "Preference: {value}",
    "local_engine.compute.running_requested": "Running request: {value}",
    "local_engine.compute.resolved_profile": "Resolved profile: {value}",
    "local_engine.compute.active_profile": "Active profile: {value}",
    "local_engine.compute.actual": "Actual backend: {value}",
    "local_engine.compute.fallback": "Auto fallback: {reasons}",
    "local_engine.compute.disabled_options": "Unavailable: {options}",
    "local_engine.compute.verification_reason": "Verification: {reason}",
    "local_engine.compute.save_failed": "Could not save this preference; the last accepted value was restored.",
    "local_engine.compute.active_mismatch": "The running service still uses {active}; restart or rebuild to apply the preference.",
    "local_engine.compute.normalized_undeclared": "Previous preference {from} is not declared for this model; using {to}.",
    "local_engine.compute.normalized": "Preference {from} was normalized to {to} for this model.",
    "local_engine.compute.install_hint": "Install the environment to apply this profile.",
    "local_engine.compute.rebuild_hint": "Rebuild the environment to apply this preference.",
    "local_engine.compute.reason.host_incompatible": "This computer is not compatible with this backend.",
    "local_engine.compute.reason.artifact_incompatible": "This model artifact is not compatible with this backend.",
    "local_engine.compute.reason.self_test_failed": "The backend self-test failed.",
    "local_engine.compute.reason.health_mismatch": "The running backend does not match this preference.",
    "local_engine.compute.reason.not_declared": "This preference is not declared for the current model.",
    "local_engine.compute.reason.compatibility_unknown": "Compatibility is not confirmed.",
