...
"chord.action.clipboard_history.subtitle": "Open the clipboard history recall panel",
  ...
  "voice.cloud.hint_unified": "Add a speech recognition model (e.g. whisper-large-v3) in the <a href=\"#\" id=\"voice-cloud-goto-ai\" class=\"external-link\">AI Providers</a> page, then select it here. API key is shared with the AI provider.",
  "voice.cloud.provider_model.label": "Provider · Model",
  "voice.cloud.provider_model.empty": "— Configure an STT model in the AI Providers page first —",
  "voice.cloud.provider_model.select": "— Select Provider · Model —",
  "voice.cloud.migration_notice": "⚠️ Legacy config detected (provider: {kind}, model: {model}). Please re-select the corresponding AI provider model from the dropdown above. The old config will be cleared automatically.",
  ...
  // ── Local Model Tab (0.12 §2.7) ──
  "local_model.lede": "Connect to local inference services. No API key needed, data never leaves your machine.",
  "local_model.ollama.desc": "Local LLM inference service, supports Chat / Embedding",
  "local_model.ollama.base_url.label": "Server URL",
  "local_model.ollama.base_url.ph": "http://localhost:11434",
  "local_model.ollama.probing": "Probing…",
  "local_model.ollama.connected": "Connected ({count} models)",
  "local_model.ollama.not_connected": "Not connected",
  "local_model.ollama.not_connected_hint": "Ollama service not detected. Please install Ollama (ollama.com) and run ollama serve.",
  "local_model.ollama.no_models": "Ollama is connected but returned no models. Use ollama pull to download models first.",
  "local_model.ollama.add_to_ai": "Add to AI Providers",
  "local_model.ollama.add_failed": "Failed to add: {err}",
  "local_model.lmstudio.desc": "Local LLM inference service, OpenAI API compatible",
  "local_model.lmstudio.step1": "<strong>Step 1:</strong> Download and install LM Studio (lmstudio.ai)",
  "local_model.lmstudio.step2": "<strong>Step 2:</strong> Download a model in LM Studio (e.g. Llama 3, Qwen)",
  "local_model.lmstudio.step3": "<strong>Step 3:</strong> Click Developer → Start Server",
  "local_model.lmstudio.step4": "<strong>Step 4:</strong> Verify the server URL (default <code>http://localhost:1234/v1</code>)",
  "local_model.lmstudio.step5": "<strong>Step 5:</strong> Add a provider in the AI Providers page with the LM Studio preset",
  "local_model.lmstudio.goto_ai": "Go to AI Providers",
