...
// 0.13.3 Skill convention
    ...
    "ai.mcp_server.hint": "Expose Blink's local capabilities (screenshot, OCR, clipboard, app search, etc.) to external MCP clients (other AI tools / IDEs / automation scripts). Start stdio mode service via `blink mcp-server` command.",
