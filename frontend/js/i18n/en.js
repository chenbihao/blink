...
"voice.cloud.test.label": "Connection test",
  ...
  "ai.memory.mode.hint": "Token Aware: dynamically trims window based on token estimation, auto-compresses when over limit. Fixed Count: always returns the most recent N messages (0.12.3 behavior)",
