...
// ── 0.21.6 Capabilities ──
    ...
    "engines.section.local_runtime": "Blink-Managed Local Model Runtime",
    "engines.section.local_runtime.desc": "FunASR / PaddleOCR and other local models are managed independently by Blink using an isolated Python runtime, not your script interpreter config.",

    // ── Local engine runtime (0.22.5) ──
    ...
    "local_engine.backend.fallback": "Fallback reason",
    ...
    "local_engine.storage.actual": "Actual",
    ...
    "local_engine.cleanup.engine_desc": "Select targets to clean. Current generation and shared assets in use will not be cleaned.",
    "local_engine.cleanup.shared_desc": "Shared cache is used by multiple engines. Cleaning may require re-downloading.",
    "local_engine.cleanup.warning_generation": "Cleaning the current generation environment is not allowed. Stop the engine first.",
    "local_engine.cleanup.warning_shared": "Shared cache is used by multiple engines. Cleaning may require re-downloading.",
    "local_engine.cleanup.scope.engine_generation": "Engine environment",
    "local_engine.cleanup.scope.engine_model_cache": "Model cache",
    "local_engine.cleanup.scope.provider_shared_artifact": "Shared artifact",
    "local_engine.cleanup.scope.provider_download_cache": "Download cache",
    "local_engine.cleanup.scope.legacy_owned_asset": "Legacy asset",
    "local_engine.cleanup.flag.current": "current",
    "local_engine.cleanup.flag.previous": "previous",
    ...
    "local_engine.cleanup.refcount": "refs",
