...
"ai.followup_placeholder": "Ask follow-up…",
    ...
    "ai.chat.lede": "Unified configuration for chat window behavior, memory strategy, Skill conventions, and MCP external tools.",
    ...
    "ai.memory.section": "Memory Strategy",
    "ai.memory.section.desc": "Context window management and history recall",
    ...
    "ai.memory.trigger_ratio.label": "Trigger Threshold (%)",
    "ai.memory.trigger_ratio.hint": "Triggers compression when total window tokens exceed this percentage of model context window. Default 80%, leaving 20% for system prompt and new messages",
    "ai.memory.compress_ratio.label": "Compress Target (%)",
    "ai.memory.compress_ratio.hint": "Maximum token ratio to retain after compression. Default 70%, compressing to 70% of model context window",
...
"ai.memory.context_size.unknown": "Unknown",
    // 0.13.2 FTS5 recall
    "ai.memory.recall.label": "Memory Recall",
    "ai.memory.recall.hint": "When enabled, messages trimmed by the window are archived to a full-text index. New conversations retrieve relevant old context via BM25 and inject it as a <memory> block. Zero embedding model dependency",
...
// 0.13.3 Skill convention
    ...
    "ai.advanced.section.desc": "AI call behavior and tool chain control",
    ...
    "ai.permission.section": "Permission Memory",
    "ai.permission.section.desc": "Cross-session memory for dangerous action confirmations",
