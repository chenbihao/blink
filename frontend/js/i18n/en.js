...
"chord.action.clipboard_history.subtitle": "Open the clipboard history recall panel",
  ...
  "voice.cloud.migration_notice": "Legacy config detected (provider: {kind}, model: {model}). Please re-select the corresponding AI provider model from the dropdown above. The old config will be cleared automatically.",
