...
"storage.clear_clipboard.confirm": "Clear all clipboard history?",
    ...
    "storage.stat.clipboard_images": "Clipboard images {count}",
    ...
    "storage.optimize.confirm": "This will run VACUUM on all three databases, which may cause brief lag. Continue?",
    "storage.optimize.success": "Storage optimization complete",
    "storage.optimize.failed": "Storage optimization failed: {err}",
    "storage.clear_cache.confirm": "Clear cache DB (performance metrics + icon cache + clipboard images)?",
