...
// ── 0.21.6 能力管理页面 ──
    ...
    "local_engine.config.requires_restart_hint": "偏好已保存，重启服务后生效。",

    // ── compute preference 显示名 ──
    "local_engine.compute.unavailable": "不可用",
    ...
    "local_engine.compute.requested": "偏好：{value}",
    "local_engine.compute.running_requested": "运行中请求：{value}",
    "local_engine.compute.resolved_profile": "解析 profile：{value}",
    "local_engine.compute.active_profile": "运行中 profile：{value}",
    "local_engine.compute.actual": "实际后端：{value}",
    "local_engine.compute.fallback": "自动回退原因：{reasons}",
    "local_engine.compute.disabled_options": "不可用选项：{options}",
    "local_engine.compute.verification_reason": "校验原因：{reason}",
    "local_engine.compute.save_failed": "计算设备偏好保存失败，已恢复服务端最后接受值。",
    "local_engine.compute.active_mismatch": "服务仍在使用 {active}；请重启或重建后应用当前偏好。",
    "local_engine.compute.normalized_undeclared": "原偏好 {from} 未被当前模型声明，已使用 {to}。",
    "local_engine.compute.normalized": "当前模型不接受原偏好 {from}，已归一化为 {to}。",
    "local_engine.compute.install_hint": "安装引擎环境后才能应用此 profile。",
    "local_engine.compute.rebuild_hint": "重建引擎环境后才能应用此偏好。",
    "local_engine.compute.reason.host_incompatible": "本机与此后端不兼容。",
    "local_engine.compute.reason.artifact_incompatible": "当前模型资源与此后端不兼容。",
    "local_engine.compute.reason.self_test_failed": "后端自检失败。",
    "local_engine.compute.reason.health_mismatch": "运行中的后端与此偏好不一致。",
    "local_engine.compute.reason.not_declared": "当前模型未声明此偏好。",
    "local_engine.compute.reason.compatibility_unknown": "尚未确认兼容性。",
