...
"chord.action.clipboard_history.subtitle": "打开剪贴板历史召回面板",
  ...
  "voice.cloud.hint_unified": "在 <a href=\"#\" id=\"voice-cloud-goto-ai\" class=\"external-link\">AI 供应商</a> 页面添加支持语音识别的模型（如 whisper-large-v3），然后在此处选择。密钥与 AI 供应商共用，无需重复配置。",
  "voice.cloud.provider_model.label": "供应商 · 模型",
  "voice.cloud.provider_model.empty": "— 请先在 AI 供应商页配置 STT 模型 —",
  "voice.cloud.provider_model.select": "— 选择供应商 · 模型 —",
  "voice.cloud.migration_notice": "⚠️ 检测到旧配置（供应商：{kind}，模型：{model}）。请在上方下拉中重新选择对应的 AI 供应商模型，旧配置将被自动清除。",
  ...
  // ── 本地模型 Tab（0.12 §2.7）──
  "local_model.lede": "连接本地推理服务，无需 API Key，数据不出本机。",
  "local_model.ollama.desc": "本地大模型推理服务，支持 Chat / Embedding",
  "local_model.ollama.base_url.label": "服务地址",
  "local_model.ollama.base_url.ph": "http://localhost:11434",
  "local_model.ollama.probing": "探测中…",
  "local_model.ollama.connected": "已连接（{count} 个模型）",
  "local_model.ollama.not_connected": "未连接",
  "local_model.ollama.not_connected_hint": "未检测到 Ollama 服务。请先安装 Ollama（ollama.com）并运行 ollama serve。",
  "local_model.ollama.no_models": "Ollama 已连接但未返回模型。请先用 ollama pull 下载模型。",
  "local_model.ollama.add_to_ai": "添加到 AI 供应商",
  "local_model.ollama.add_failed": "添加失败：{err}",
  "local_model.lmstudio.desc": "本地大模型推理服务，兼容 OpenAI API",
  "local_model.lmstudio.step1": "<strong>步骤 1：</strong>下载安装 LM Studio（lmstudio.ai）",
  "local_model.lmstudio.step2": "<strong>步骤 2：</strong>在 LM Studio 中下载所需模型（如 Llama 3、Qwen 等）",
  "local_model.lmstudio.step3": "<strong>步骤 3：</strong>点击「Developer」→「Start Server」启动本地服务",
  "local_model.lmstudio.step4": "<strong>步骤 4：</strong>确认服务地址（默认 <code>http://localhost:1234/v1</code>）",
  "local_model.lmstudio.step5": "<strong>步骤 5：</strong>在上方「AI 供应商」页面添加供应商，选择 LM Studio 预设即可",
  "local_model.lmstudio.goto_ai": "前往 AI 供应商配置",
  // 本地 - Python 环境
