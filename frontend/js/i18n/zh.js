...
"storage.clear_clipboard.confirm": "确定清空所有剪贴板记录？",
    ...
    "storage.stat.clipboard_images": "剪贴板图片 {count} 条",
    ...
    "storage.optimize.confirm": "将对三个数据库执行 VACUUM 收缩操作，期间可能短暂卡顿。继续？",
    "storage.optimize.success": "存储优化完成",
    "storage.optimize.failed": "存储优化失败：{err}",
    "storage.clear_cache.confirm": "确定清空缓存库（性能指标 + 图标缓存 + 剪贴板图片）？",
