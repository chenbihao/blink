...
const DICT = {
  zh: {
    ...
    "ai.advanced.timeout.hint": "单次 AI 调用最长等待时间。超过自动 fallback。建议 ≤ 3000",
    "ai.modal.title": "添加 AI 供应商",
    "ai.modal.kind": "供应商种类",
    "ai.modal.kind.openai": "OpenAI",
    "ai.modal.kind.deepseek": "DeepSeek",
    "ai.modal.kind.anthropic": "Anthropic",
    "ai.modal.kind.openai_compat": "OpenAI 兼容（Groq / Moonshot / 自建）",
  ...
  en: {
    ...
    "ai.advanced.timeout.hint": "Max wait for one AI call. Exceeds → fallback. Recommended ≤ 3000",
    "ai.modal.title": "Add AI Provider",
    "ai.modal.kind": "Provider kind",
    "ai.modal.kind.openai": "OpenAI",
    "ai.modal.kind.deepseek": "DeepSeek",
    "ai.modal.kind.anthropic": "Anthropic",
    "ai.modal.kind.openai_compat": "OpenAI compat (Groq / Moonshot / self-hosted)",
