...
const DICT = {
  zh: {
    ...
    "ai.model_modal.model_id.hint": "供应商 API 使用的 id，不可与本供应商下其他模型重复",
    ...
    "ai.model_modal.fetch.title": "从供应商拉取可用模型",
    "ai.model_modal.fetch.filter.ph": "搜索模型 id…",
  ...
  en: {
    ...
    "ai.model_modal.model_id.hint": "The id used by the provider API; must be unique within this provider.",
    ...
    "ai.model_modal.fetch.title": "Fetch available models from provider",
    "ai.model_modal.fetch.filter.ph": "Search model id…",
