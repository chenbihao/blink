...
const DICT = {
  zh: {
    ...
    "general.theme.nord-polar-night": "Polar Night 极夜",
    "general.theme.nord-snow-storm": "Snow Storm 暴风雪",
    "general.theme.nord-frost": "Frost 霜",
    "general.theme.nord-aurora": "Aurora 极光",
    "general.theme.nvchad-aquarium": "NvChad Aquarium",
    "general.theme.nvchad-ashes": "NvChad Ashes",
    "general.theme.nvchad-ayu_light": "NvChad Ayu Light",
    "general.theme.nvchad-bearded-arc": "NvChad Bearded Arc",
    "general.theme.nvchad-blossom_light": "NvChad Blossom Light",
    "general.theme.nvchad-catppuccin": "NvChad Catppuccin",
    "general.theme.nvchad-chadracula-evondev": "NvChad Chadracula Evondev",
    "general.theme.nvchad-chadracula": "NvChad Chadracula",
    "general.theme.nvchad-chadtain": "NvChad Chadtain",
    "general.theme.nvchad-chocolate": "NvChad Chocolate",
    "general.theme.nvchad-dark_horizon": "NvChad Dark Horizon",
    "general.theme.nvchad-decay": "NvChad Decay",
    "general.theme.nvchad-doomchad": "NvChad Doomchad",
    "general.theme.nvchad-everblush": "NvChad Everblush",
    "general.theme.nvchad-everforest": "NvChad Everforest",
    "general.theme.nvchad-everforest_light": "NvChad Everforest Light",
    "general.theme.nvchad-falcon": "NvChad Falcon",
    "general.theme.nvchad-flex-light": "NvChad Flex Light",
    "general.theme.nvchad-flexoki-light": "NvChad Flexoki Light",
    "general.theme.nvchad-flexoki": "NvChad Flexoki",
    "general.theme.nvchad-gatekeeper": "NvChad Gatekeeper",
    "general.theme.nvchad-github_dark": "NvChad Github Dark",
    "general.theme.nvchad-github_light": "NvChad Github Light",
    "general.theme.nvchad-gruvbox": "NvChad Gruvbox",
    "general.theme.nvchad-gruvbox_light": "NvChad Gruvbox Light",
    "general.theme.nvchad-gruvchad": "NvChad Gruvchad",
    "general.theme.nvchad-jabuti": "NvChad Jabuti",
    "general.theme.nvchad-jellybeans": "NvChad Jellybeans",
    "general.theme.nvchad-kanagawa": "NvChad Kanagawa",
    "general.theme.nvchad-material-darker": "NvChad Material Darker",
    "general.theme.nvchad-material-lighter": "NvChad Material Lighter",
    "general.theme.nvchad-melange": "NvChad Melange",
    "general.theme.nvchad-mito-laser": "NvChad Mito Laser",
    "general.theme.nvchad-monekai": "NvChad Monekai",
    "general.theme.nvchad-monochrome": "NvChad Monochrome",
    "general.theme.nvchad-mountain": "NvChad Mountain",
    "general.theme.nvchad-nano-light": "NvChad Nano Light",
    "general.theme.nvchad-nightfox": "NvChad Nightfox",
    "general.theme.nvchad-nightlamp": "NvChad Nightlamp",
    "general.theme.nvchad-nightowl": "NvChad Nightowl",
    "general.theme.nvchad-nord": "NvChad Nord",
    "general.theme.nvchad-oceanic-light": "NvChad Oceanic Light",
    "general.theme.nvchad-oceanic-next": "NvChad Oceanic Next",
    "general.theme.nvchad-one_light": "NvChad One Light",
    "general.theme.nvchad-onedark": "NvChad Onedark",
    "general.theme.nvchad-onenord": "NvChad Onenord",
    "general.theme.nvchad-onenord_light": "NvChad Onenord Light",
    "general.theme.nvchad-oxocarbon": "NvChad Oxocarbon",
    "general.theme.nvchad-palenight": "NvChad Palenight",
    "general.theme.nvchad-pastelDark": "NvChad Pasteldark",
    "general.theme.nvchad-pastelbeans": "NvChad Pastelbeans",
    "general.theme.nvchad-penumbra_dark": "NvChad Penumbra Dark",
    "general.theme.nvchad-penumbra_light": "NvChad Penumbra Light",
    "general.theme.nvchad-poimandres": "NvChad Poimandres",
    "general.theme.nvchad-radium": "NvChad Radium",
    "general.theme.nvchad-rosepine-dawn": "NvChad Rosepine Dawn",
    "general.theme.nvchad-rosepine": "NvChad Rosepine",
    "general.theme.nvchad-rxyhn": "NvChad Rxyhn",
    "general.theme.nvchad-solarized_dark": "NvChad Solarized Dark",
    "general.theme.nvchad-solarized_osaka": "NvChad Solarized Osaka",
    "general.theme.nvchad-sweetpastel": "NvChad Sweetpastel",
    "general.theme.nvchad-tokyodark": "NvChad Tokyodark",
    "general.theme.nvchad-tokyonight": "NvChad Tokyonight",
    "general.theme.nvchad-tomorrow_night": "NvChad Tomorrow Night",
    "general.theme.nvchad-tundra": "NvChad Tundra",
    "general.theme.nvchad-vscode_dark": "NvChad Vscode Dark",
    "general.theme.nvchad-wombat": "NvChad Wombat",
    "general.theme.nvchad-yoru": "NvChad Yoru",
    ...
    "general.theme.jay-november": "十一月的萧邦",
    "general.theme.jay-ye-huimei": "叶惠美",
    ...
    "engine.start_menu.include_uwp.hint": "搜索 Microsoft Store 安装的打包应用（如 Kazumi）",
  ...
  en: {
    ...
    "general.theme.gruvbox": "Gruvbox Dark",
    "general.theme.nord-polar-night": "Polar Night",
    "general.theme.nord-snow-storm": "Snow Storm",
    "general.theme.nord-frost": "Frost",
    "general.theme.nord-aurora": "Aurora",
    "general.theme.nvchad-aquarium": "NvChad Aquarium",
    "general.theme.nvchad-ashes": "NvChad Ashes",
    "general.theme.nvchad-ayu_light": "NvChad Ayu Light",
    "general.theme.nvchad-bearded-arc": "NvChad Bearded Arc",
    ...
    "general.theme.jay-november": "November's Chopin",
    "general.theme.jay-ye-huimei": "Ye Huimei",
    ...
    "engine.start_menu.include_uwp.hint": "Search packaged apps installed from Microsoft Store (e.g. Kazumi)",
