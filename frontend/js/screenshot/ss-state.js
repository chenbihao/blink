...
export const ss = {
    ...
    // 0.20.7：paletteWorker 已移除，配色分析改由后端 Rust 单一真源完成
    ...
    // P1-3：paletteFormat 已移除，配色区复用顶部 .color-format 的格式状态（ss-color-picker.js）
