...
import {
  getRenderScale, setRenderScale, syncRenderScale,
  overlayDpr,
  monitorDprAtCss, monitorDprAtScreen,
  dprAtCss, dprAtScreen,
  screenToBitmap, bitmapToScreen,
  screenPointToCss, cssPointToScreen,
  bitmapPointToCss, cssPointToBitmap,
  cssRectToBitmap, bitmapRectToCss,
  screenRectToCss, cssRectToScreen,
  rectScreenToCss, rectCssToScreen,
  rectScreenToBitmap, rectBitmapToScreen,
  clampRectToBitmap, clampRectToCss,
